...
public enum Ducts {
    ...
    ENERGY_BASIC(0, false, 1, 0, "energyBasicDuct", Type.Energy, DuctFactory.energy, "lead", "thermaldynamics:duct/energy/ConnectionEnergy00",
            Constants.redstone_block, 255, null, null, 255),

    ENERGY_HARDENED(1, false, 1, 1, "energyHardenedDuct", Type.Energy, DuctFactory.energy, "invar", "thermaldynamics:duct/energy/ConnectionEnergy10",
            Constants.redstone_block, 255, null, null, 0),

    ENERGY_REINFORCED(2, false, 1, 2, "energyReinforcedDuct", Type.Energy, DuctFactory.energy, "electrum", "thermaldynamics:duct/energy/ConnectionEnergy20",
            "thermalfoundation:fluid/Fluid_Redstone_Still", 192, null, null, 0),

    FLUID_TRANS(3, false, 1, 0, "fluidWeakDuct", Type.Fluid, DuctFactory.fluid_fragile, "copper", "thermaldynamics:duct/fluid/ConnectionFluid00", null, 0,
            null, null, 0),

    FLUID_OPAQUE(4, true, 1, 0, "fluidWeakDuct", Type.Fluid, DuctFactory.fluid_fragile, "copper", "thermaldynamics:duct/fluid/ConnectionFluid00", null, 0,
            null, null, 0),

    FLUID_HARDENED_TRANS(11, false, 1, 1, "fluidDuct", Type.Fluid, DuctFactory.fluid, "invar", "thermaldynamics:duct/fluid/ConnectionFluid10", null, 0, null,
            null, 0),

    FLUID_HARDENED_OPAQUE(12, true, 1, 1, "fluidDuct", Type.Fluid, DuctFactory.fluid, "invar", "thermaldynamics:duct/fluid/ConnectionFluid11", null, 0, null,
            null, 0),

    ENERGY_REINFORCED_EMPTY(9, false, 1, -1, "energyEmptyReinforcedDuct", Type.Structural, DuctFactory.structural, "electrum",
    ...
    ENERGY_SUPERCONDUCTOR(13, false, 1, 3, "energySuperconductorDuct", Type.Energy, DuctFactory.energy_super, "electrum",
    ...
    ENERGY_SUPERCONDUCTOR_EMPTY(14, false, 1, -1, "energySuperconductorEmptyDuct", Type.Energy, DuctFactory.structural, "electrum",
            "thermaldynamics:duct/energy/ConnectionEnergy20", "thermalfoundation:fluid/Fluid_Redstone_Still", 192,
    ...
    ITEM_FAST_TRANS(7, false, 1, 1, "itemDuctFast", Type.Item, DuctFactory.item, "tin", "thermaldynamics:duct/item/ConnectionItem00",
    ...
    ITEM_ENDERIUM_TRANS(15, false, 0, 2, "itemDuctEnder", Type.Item, DuctFactory.item_ender, "enderium", "thermaldynamics:duct/item/ConnectionItem20", null,
            48, null, null, 0),

    ITEM_ENDERIUM_OPAQUE(16, true, 0, 2, "itemDuctEnder", Type.Item, DuctFactory.item_ender, "enderium", "thermaldynamics:duct/item/ConnectionItem20", null,
            48, null, null, 0),

    ITEM_REDSTONE_TRANS(17, false, 1, 3, "itemDuctRedstone", Type.Item, DuctFactory.item_redstone, "tin", "thermaldynamics:duct/item/ConnectionItem00",
            "thermalfoundation:fluid/Fluid_Redstone_Still", 48, null, null, 0),

    ITEM_REDSTONE_OPAQUE(18, true, 1, 3, "itemDuctRedstone", Type.Item, DuctFactory.item_redstone, "tin_2", "thermaldynamics:duct/item/ConnectionItem00", null,
            0, null, null, 0),
    ...
    ITEM_FAST_TRANS_DENSE(21, false, 1000, 1, "itemDuctFast", Type.Item, DuctFactory.item, "tin", "thermaldynamics:duct/item/ConnectionItem00",
            "thermalfoundation:fluid/Fluid_Glowstone_Still", 128, null, null, 0),

    ITEM_FAST_OPAQUE_DENSE(22, true, 1000, 1, "itemDuctFast", Type.Item, DuctFactory.item, "tin_1", "thermaldynamics:duct/item/ConnectionItem00", null, 0,
            null, null, 0),

    ITEM_ENDERIUM_TRANS_DENSE(23, false, 1000, 2, "itemDuctEnder", Type.Item, DuctFactory.item_ender, "enderium", "thermaldynamics:duct/item/ConnectionItem20",
            null, 48, null, null, 0),

    ITEM_ENDERIUM_OPAQUE_DENSE(24, true, 1000, 2, "itemDuctEnder", Type.Item, DuctFactory.item_ender, "enderium", "thermaldynamics:duct/item/ConnectionItem20",
            null, 48, null, null, 0),

    ITEM_REDSTONE_TRANS_DENSE(25, false, 1000, 3, "itemDuctRedstone", Type.Item, DuctFactory.item_redstone, "tin",
            "thermaldynamics:duct/item/ConnectionItem00", "thermalfoundation:fluid/Fluid_Redstone_Still", 48, null, null, 0),

    ITEM_REDSTONE_OPAQUE_DENSE(26, true, 1000, 3, "itemDuctRedstone", Type.Item, DuctFactory.item_redstone, "tin_2",
    ...
    ITEM_FAST_TRANS_VACUUM(29, false, -1000, 1, "itemDuctFast", Type.Item, DuctFactory.item, "tin", "thermaldynamics:duct/item/ConnectionItem00",
            "thermalfoundation:fluid/Fluid_Glowstone_Still", 128, null, null, 0),

    ITEM_FAST_OPAQUE_VACUUM(30, true, -1000, 1, "itemDuctFast", Type.Item, DuctFactory.item, "tin_1", "thermaldynamics:duct/item/ConnectionItem00", null, 0,
            null, null, 0),

    ITEM_ENDERIUM_TRANS_VACUUM(31, false, -1000, 2, "itemDuctEnder", Type.Item, DuctFactory.item_ender, "enderium",
            "thermaldynamics:duct/item/ConnectionItem20", null, 48, null, null, 0),

    ITEM_ENDERIUM_OPAQUE_VACUUM(32, true, -1000, 2, "itemDuctEnder", Type.Item, DuctFactory.item_ender, "enderium",
            "thermaldynamics:duct/item/ConnectionItem20", null, 48, null, null, 0),

    ITEM_REDSTONE_TRANS_VACUUM(33, false, -1000, 3, "itemDuctRedstone", Type.Item, DuctFactory.item_redstone, "tin",
            "thermaldynamics:duct/item/ConnectionItem00", "thermalfoundation:fluid/Fluid_Redstone_Still", 48, null, null, 0),

    ITEM_REDSTONE_OPAQUE_VACUUM(34, true, -1000, 3, "itemDuctRedstone", Type.Item, DuctFactory.item_redstone, "tin_2",
            "thermaldynamics:duct/item/ConnectionItem00", null, 0, null, null, 0),

    FLUID_REDSTONE_TRANS(35, false, 1, 1, "fluidDuctRedstone", Type.Fluid, DuctFactory.fluid_redstone, "invar", "thermaldynamics:duct/fluid/ConnectionFluid10", null, 0, Constants.sideDucts,
    ...
    public void registerIcons(IIconRegister ir) {
        ...
        if (overDuct2 != null) {
            if (overDuctsType == 0) overDuctsType = 2;
    ...
    public static abstract class DuctFactory {
        ...
        public static DuctFactory fluid_redstone = new DuctFactory() {
            @Override
            public TileMultiBlock createTileEntity(Ducts duct, World worldObj) {
                return new TileFluidDuctRedstone();
            }
        };
