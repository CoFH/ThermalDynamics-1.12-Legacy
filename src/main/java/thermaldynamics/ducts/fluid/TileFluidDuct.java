...
public class TileFluidDuct extends TileMultiBlock implements IFluidHandler {
    ...
    public IFilterFluid[] filterCache = {IFilterFluid.nullFilter, IFilterFluid.nullFilter, IFilterFluid.nullFilter, IFilterFluid.nullFilter, IFilterFluid.nullFilter, IFilterFluid.nullFilter};
