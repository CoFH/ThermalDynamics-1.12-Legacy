...
//
//		if (Utils.isHoldingUsableWrench(player, getPos())) {
...
//				player.openGui(ThermalDynamics.instance, GuiHandler.TILE_ID, worldObj, getPos().getX(), getPos().getY(), getPos().getZ());
//				return true;
//			}
//		}
//
...
//			thePlayer.openGui(ThermalDynamics.instance, GuiHandler.TILE_CONFIG, worldObj, getPos().getX(), getPos().getY(), getPos().getZ());
//		}
//	}
//
...
//
//		PacketHandler.sendTo(getPacket(), player);
//		player.openGui(ThermalDynamics.instance, GuiHandler.TILE_CONFIG, worldObj, getPos().getX(), getPos().getY(), getPos().getZ());
//		return true;
//	}
//
