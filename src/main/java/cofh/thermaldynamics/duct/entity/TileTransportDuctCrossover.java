...
//			if (i < 2 || worldObj.isBlockLoaded(getPos().add(face.getFrontOffsetX(), 0, face.getFrontOffsetZ()))) {
//				rangePos[i] = null;
...
//		TileEntity theTile;
//
//		if (worldObj.isBlockLoaded(rangePos[i].pos())) {
//			theTile = worldObj.getTileEntity(rangePos[i].pos());
//
...
//			}
//
//			player.addChatComponentMessage(new TextComponentString("Searching on side - " + EnumFacing.VALUES[i]));
//
...
//					worldObj.getChunkFromBlockCoords(getPos().add(face.getFrontOffsetX(), 0, face.getFrontOffsetZ()));
//				}
//				TileEntity side = worldObj.getTileEntity(pos.pos());
//
...
//				finalDest.rangePos[d ^ 1] = new BlockPosition(this).setOrientation(EnumFacing.VALUES[i ^ 1]);
...
//				}
//			} else {
//				player.addChatComponentMessage(new TextComponentString("Failed at - (" + pos.x + ", " + pos.y + ", " + pos.z + ")"));
//			}
//		}
//
