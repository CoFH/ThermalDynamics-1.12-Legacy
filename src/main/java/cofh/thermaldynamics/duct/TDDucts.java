...
public class TDDucts {
	...
	public static int OFFSET_ENDER = 5 * 16;
	...
	static void addEnergyDucts() {
		...
		energySuperCond = addDuct(OFFSET_ENERGY + 5, false, 1, 5, "energySuper", Type.ENERGY, (duct, worldObj) -> new TileDuctEnergySuper(), "enderium", "enderium", REDSTONE_STILL, 255, "electrum", CRYOTHEUM_STILL, 96);
